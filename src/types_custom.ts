...
export class AuthClient {
    ...
    signIn(user: UserCreateRequest): Promise<Message> {
    ...
    signUp(user: SignupUserRequest): Promise<Message> {
    ...
    create(user: UserCreateRequest): Promise<Message> {
    ...
    remove(id: string | undefined): Promise<Message> {
...
export class DisciplinesClient {
     ...
     */
    getAll(currentPage: number | undefined, pageSize: number | undefined, sort: string | null | undefined, filter: string | null | undefined): Promise<PagedResultOfDisciplineResponseDto> {
     ...
     */
    create(body: DisciplineRequestDto): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/disciplines";
        url_ = url_.replace(/[?&]$/, "");
    ...
    createAsync2(id: string | undefined, name: string | undefined, description: string | undefined, image: string | null | undefined, parentId: string | null | undefined): Promise<FileResponse | null> {
    ...
    upload(file: FileParameter | undefined, fileName: string | undefined, folderName: string | undefined): Promise<FileResponse | null> {
...
export class ErrorClient {
    ...
    handleErrorDevelopmentGET(): Promise<FileResponse | null> {
    ...
    handleErrorDevelopmentPOST(): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/error";
        url_ = url_.replace(/[?&]$/, "");
...
export class MessagesClient {
    ...
    getPublicMessage(): Promise<Message> {
    ...
    getProtectedMessage(): Promise<Message> {
    ...
    getAdminMessage(): Promise<Message> {
...
export class QuestionBankClient {
     ...
     * @return A PagedResult T with queryable holding the items
     */
    getAll(currentPage: number | undefined, pageSize: number | undefined, sort: string | null | undefined, filter: string | null | undefined): Promise<PagedResultOfQuestionBankResponseDto> {
        let url_ = this.baseUrl + "/api/questions_bank?";
        if (currentPage === null)
            throw new Error("The parameter 'currentPage' cannot be null.");
        else if (currentPage !== undefined)
            url_ += "CurrentPage=" + encodeURIComponent("" + currentPage) + "&";
     ...
     * @return The created item T
     */
    create(body: QuestionBankRequestDto): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/questions_bank";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    get(id: string): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/questions_bank/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return True on success, false otherwise
     */
    update(id: string, body: QuestionBankRequestDto): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/questions_bank/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    createAsync2(id: string | undefined, name: string | undefined, institutionId: string | null | undefined): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/questions_bank/file";
        url_ = url_.replace(/[?&]$/, "");
    ...
    upload(file: FileParameter | undefined, fileName: string | undefined, folderName: string | undefined): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/questions_bank/upload?";
        if (fileName === null)
            throw new Error("The parameter 'fileName' cannot be null.");
        else if (fileName !== undefined)
            url_ += "fileName=" + encodeURIComponent("" + fileName) + "&";
...
export class QuestionClient {
    ...
    getMyAnswers(): Promise<FileResponse | null> {
     ...
     * @return A PagedResult T with queryable holding the items
     */
    getAll(currentPage: number | undefined, pageSize: number | undefined, sort: string | null | undefined, filter: string | null | undefined): Promise<PagedResultOfQuestionResponseDto> {
     ...
     * @return The created item T
     */
    create(body: QuestionRequestDto): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/questions";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return True on success, false otherwise
     */
    update(id: string, body: QuestionRequestDto): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/questions/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
...
export class InstitutionsClient {
     ...
     * @return A PagedResult T with queryable holding the items
     */
    getAll(currentPage: number | undefined, pageSize: number | undefined, sort: string | null | undefined, filter: string | null | undefined): Promise<PagedResultOfInstitutionResponseDto> {
     ...
     * @return The created item T
     */
    create(body: InstitutionRequestDto): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/institutions";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return True on success, false otherwise
     */
    update(id: string, body: InstitutionRequestDto): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/institutions/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    createAsync2(id: string | undefined, name: string | undefined, state: string | undefined, stadual: boolean | undefined, privateInstitution: boolean | undefined): Promise<FileResponse | null> {
...
export class AnswerClient {
    ...
    generateFakeAnswers(): Promise<FileResponse | null> {
     ...
     * @return A PagedResult T with queryable holding the items
     */
    getAll(currentPage: number | undefined, pageSize: number | undefined, sort: string | null | undefined, filter: string | null | undefined): Promise<PagedResultOfAnswerResponseDto> {
     ...
     * @return The created item T
     */
    create(body: AnswerRequestDto): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/answers";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return True on success, false otherwise
     */
    update(id: string, body: AnswerRequestDto): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/answers/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    createAsync2(id: string | undefined, questionId: string | null | undefined, user: string | undefined, alternativeId: string | null | undefined, correct: boolean | undefined, quizAttemptId: string | null | undefined): Promise<FileResponse | null> {
...
export class UserClient {
    ...
    getPermissions(id: string, paginationInfo: PaginationInfo): Promise<Message> {
    ...
    addPermission(id: string, permissionsRequest: AssignPermissionsRequest): Promise<Message> {
        let url_ = this.baseUrl + "/api/users/permissions/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    getRoles(id: string, paginationInfo: PaginationInfo): Promise<Message> {
    ...
    addRole(id: string, rolesRequest: AssignRolesRequest): Promise<Message> {
        let url_ = this.baseUrl + "/api/users/roles/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    get2(currentPage: number | undefined, pageSize: number | undefined, filter: string | null | undefined, sort: string | null | undefined): Promise<FileResponse | null> {
...
export class SignupUserRequest extends UserMaintenanceRequestBase implements ISignupUserRequest {
    ...
    static fromJS(data: any): SignupUserRequest {
        data = typeof data === 'object' ? data : {};
...
export class PagedResultOfDisciplineResponseDto extends PagedResult implements IPagedResultOfDisciplineResponseDto {
    ...
    static fromJS(data: any): PagedResultOfDisciplineResponseDto {
        data = typeof data === 'object' ? data : {};
...
export class DisciplineResponseDto extends DisciplineRequestDto implements IDisciplineResponseDto {
    ...
    static fromJS(data: any): DisciplineResponseDto {
        data = typeof data === 'object' ? data : {};
...
export class AnswerResponseDto extends AnswerRequestDto implements IAnswerResponseDto {
    ...
    static fromJS(data: any): AnswerResponseDto {
        data = typeof data === 'object' ? data : {};
...
export class QuizAttemptResponseDto extends QuizAttemptRequestDto implements IQuizAttemptResponseDto {
    ...
    static fromJS(data: any): QuizAttemptResponseDto {
        data = typeof data === 'object' ? data : {};
...
export class ObservationResponseDto extends ObservationRequestDto implements IObservationResponseDto {
    ...
    static fromJS(data: any): ObservationResponseDto {
        data = typeof data === 'object' ? data : {};
...
export class ObservationRequestResponseDto extends ObservationRequestRequestDto implements IObservationRequestResponseDto {
    ...
    static fromJS(data: any): ObservationRequestResponseDto {
        data = typeof data === 'object' ? data : {};
...
export class QuestionBank extends BaseEntity implements IQuestionBank {
    ...
    static fromJS(data: any): QuestionBank {
        data = typeof data === 'object' ? data : {};
...
export class QuizAttempt extends BaseEntity implements IQuizAttempt {
    ...
    static fromJS(data: any): QuizAttempt {
        data = typeof data === 'object' ? data : {};
...
export class QuizAttemptConfiguration extends BaseEntity implements IQuizAttemptConfiguration {
    ...
    static fromJS(data: any): QuizAttemptConfiguration {
        data = typeof data === 'object' ? data : {};
...
export class ObservationRequest extends BaseEntity implements IObservationRequest {
    ...
    static fromJS(data: any): ObservationRequest {
        data = typeof data === 'object' ? data : {};
...
export class Discipline extends BaseEntity implements IDiscipline {
    ...
    static fromJS(data: any): Discipline {
        data = typeof data === 'object' ? data : {};
...
export class PagedResultOfQuestionBankResponseDto extends PagedResult implements IPagedResultOfQuestionBankResponseDto {
    ...
    static fromJS(data: any): PagedResultOfQuestionBankResponseDto {
        data = typeof data === 'object' ? data : {};
...
export class QuestionBankResponseDto extends QuestionBankRequestDto implements IQuestionBankResponseDto {
    ...
    static fromJS(data: any): QuestionBankResponseDto {
        data = typeof data === 'object' ? data : {};
...
export class PagedResultOfQuestionResponseDto extends PagedResult implements IPagedResultOfQuestionResponseDto {
    ...
    static fromJS(data: any): PagedResultOfQuestionResponseDto {
        data = typeof data === 'object' ? data : {};
...
export class PagedResultOfInstitutionResponseDto extends PagedResult implements IPagedResultOfInstitutionResponseDto {
    ...
    static fromJS(data: any): PagedResultOfInstitutionResponseDto {
        data = typeof data === 'object' ? data : {};
...
export class PagedResultOfAnswerResponseDto extends PagedResult implements IPagedResultOfAnswerResponseDto {
    ...
    static fromJS(data: any): PagedResultOfAnswerResponseDto {
        data = typeof data === 'object' ? data : {};
