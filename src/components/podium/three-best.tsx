    ...
    return <>
        <div className="flex flex-col items-center justify-center mx-auto">
            <div className="flex justify-around w-full mb-6 relative p-6">
                <div className="absolute left-6 top-10 w-full max-w-[72px] flex flex-col items-center justify-center">
                    <span
                        className='block text-center py-1 px-4 text-xs rounded-full bg-gray-200 dark:text-default-200 text-default-600 font-bold absolute -top-5 left-0 right-0 w-full'>
                ...
                <div className="absolute -top-4 w-full max-w-[72px] flex flex-col items-center justify-center">
        <span
            className='block text-center py-1 px-4 text-xs rounded-full bg-gray-200 dark:text-default-200 text-default-600 font-bold absolute -top-5 left-0 right-0 w-full'>
