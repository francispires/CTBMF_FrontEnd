...
export const QuestionsFilter = (props: Props) => {
    ...
    return (
        <>
            ...
            >
                <AccordionItem key="1" aria-label="Filtros" title="Filtros"  indicator={<SearchIcon />}>
            ...
            <Button className={""} color={"danger"} variant={"shadow"} size={"md"}
                    onClick={props.FilterChanged}>Filtrar</Button>
        </>
    );
}